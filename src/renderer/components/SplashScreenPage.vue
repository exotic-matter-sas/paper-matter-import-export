        ...
        <div id="splash-screen" class="text-center text-primary">
          ...
          <span v-else>
            ...
            <b-progress
              ...
              variant="primary"
              :value="downloadCurrentProgress"
              :max="downloadTotalProgress"
...
export default {
  ...
  mounted() {
    ...
    if (
      ...
      this.$router.push({ name: "login" });
      log.info(
        "checkForUpdates skipped as neither in production mode or env DEBUG=='electron-builder'"
      );
    }
  },
