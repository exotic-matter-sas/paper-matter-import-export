    ...
    <b-container fluid>
      <b-row class="align-items-center">
        ...
        <b-col v-if="action === 'export' && currentStep === 1">
          <b-row>
            <h1 class="text-primary">
              {{ $t("progressModal.exportTitle1") }}
            </h1>
            <h2 class="text-muted font-italic">
              {{ $t("progressModal.exportSubTitle1") }}
            </h2>
          </b-row>
          <b-row class="align-items-end">
            <b-col cols="12">
              <b-progress
                id="export-progress-bar-1"
                height="2rem"
                variant="primary"
                :value="currentCount"
                :max="totalCount"
        ...
        <b-col v-if="action === 'export' && currentStep === 2">
          <b-row>
            <h1 class="text-primary">
              {{ $t("progressModal.exportTitle2") }}
            </h1>
            <h2 class="text-muted font-italic">
              {{ $t("progressModal.exportSubTitle2") }}
            </h2>
          </b-row>
          <b-row class="align-items-end">
            <b-col cols="12">
              <b-progress
                id="export-progress-bar-2"
                height="2rem"
                variant="primary"
                :value="currentCount"
                :max="totalCount"
