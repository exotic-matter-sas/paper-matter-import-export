...
export default class ApiClient {
  ...
  getAccessToken(code) {
    ...
    return this.http.post("/oauth2/token", data);
  }
  ...
  revokeToken(token, token_type_hint = "access_token") {
    ...
    return this.http.post("/oauth2/revoke_token", data);
  }
  ...
  getUserData(accessToken) {
    return this.http.get(`/app/api/v1/users/me`, {
  ...
  listFolders(accessToken, parent = null) {
    ...
    return this.http.get(`/app/api/v1/folders${queryString}`, {
      headers: { Authorization: "Bearer " + accessToken },
    });
  }
  ...
  uploadDocument(accessToken, jsonData, file, thumbnail = null) {
    ...
    return this.http.post("/app/api/v1/documents/upload", formData, {
      headers: { Authorization: "Bearer " + accessToken },
    });
  }
  ...
  listDocuments(accessToken, page = 1, level = null) {
    ...
    return this.http.get(`/app/api/v1/documents?flat${queryString}`, {
      headers: { Authorization: "Bearer " + accessToken },
    });
  }
